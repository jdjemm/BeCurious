...
<!-- #!
We hope you enjoyed taking part in our chocolate egg clinical trial at Be Curious! Here are the results from our trial today.
...
When interpreting the odds ratio, it is important that we also use the confidence interval in order to make a conclusion about our test. As we have used 95% confidence intervals here, we can say we are 95% sure (so pretty sure), that the real value is inside our confidence intervals, so bigger than XX but smaller than XX.

<!-- #!DELETE ONE OF THESE ACCORDING TO THE RESULT! -->
<!-- #!
Here, XX is the odds ratio and (XX - XX) is the confidence interval. As we can see, 1 is within the confidence interval. This means that **type of chocolate egg does not affect happiness**.

Here, XX is the odds ratio and (XX - XX) is the confidence interval. As we can see, 1 is within the confidence interval. This means that **type of chocolate egg affects happiness**.
...
As we can see, 1 is within the confidence interval for XX but is not within the interval for XX. This means that while there is not an association between XX and happiness after eating chocolate, there is an association between XX and happiness after eating chocolate.

So we can conclude that from the group we tested, people who were very happy before eating chocolate are more likely to be happy after eating chocolate in comparison to someone who is unhappy before eating chocolate.

So we can conclude that from the group we tested, children are more likely to be happy after eating chocolate in comparison to adults.

So we can conclude that from the group we tested, people who prefer to eat milk chocolate over white chocolate are more likely to be happy after eating chocolate in comparison to someone who prefers white chocolate.
!-->